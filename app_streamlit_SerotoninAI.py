...
if selected == "Home":
    ...
    st.write("My name is **Natalia Czub** and I am the author of ***SerotoninAI***. I hope this application will help develop therapies for new drugs affecting the central nervous system. ")
